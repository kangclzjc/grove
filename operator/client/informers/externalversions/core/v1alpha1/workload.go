...
type WorkloadInformer interface {
	...
	Lister() corev1alpha1.WorkloadLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GroveV1alpha1().Workloads(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroveV1alpha1().Workloads(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroveV1alpha1().Workloads(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroveV1alpha1().Workloads(namespace).Watch(ctx, options)
			},
		},
		&apicorev1alpha1.Workload{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workloadInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apicorev1alpha1.Workload{}, f.defaultInformer)
}

func (f *workloadInformer) Lister() corev1alpha1.WorkloadLister {
	return corev1alpha1.NewWorkloadLister(f.Informer().GetIndexer())
}
