...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DefaultSchedulerConfiguration) DeepCopyInto(out *DefaultSchedulerConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DefaultSchedulerConfiguration.
func (in *DefaultSchedulerConfiguration) DeepCopy() *DefaultSchedulerConfiguration {
	if in == nil {
		return nil
	}
	out := new(DefaultSchedulerConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SchedulerConfiguration) DeepCopyInto(out *SchedulerConfiguration) {
	*out = *in
	if in.Kai != nil {
		in, out := &in.Kai, &out.Kai
		*out = new(KaiSchedulerConfiguration)
		**out = **in
	}
	if in.DefaultScheduler != nil {
		in, out := &in.DefaultScheduler, &out.DefaultScheduler
		*out = new(DefaultSchedulerConfiguration)
		**out = **in
	}
	return
...
func (in *TopologyAwareSchedulingConfiguration) DeepCopyInto(out *TopologyAwareSchedulingConfiguration) {
	*out = *in
	if in.Levels != nil {
		...
		*out = make([]corev1alpha1.TopologyLevel, len(*in))
		copy(*out, *in)
	}
	return
}
