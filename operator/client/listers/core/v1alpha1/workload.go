...
type WorkloadLister interface {
	...
	List(selector labels.Selector) (ret []*corev1alpha1.Workload, err error)
...
type workloadLister struct {
	listers.ResourceIndexer[*corev1alpha1.Workload]
}

// NewWorkloadLister returns a new WorkloadLister.
func NewWorkloadLister(indexer cache.Indexer) WorkloadLister {
	return &workloadLister{listers.New[*corev1alpha1.Workload](indexer, corev1alpha1.Resource("workload"))}
}

// Workloads returns an object that can list and get Workloads.
func (s *workloadLister) Workloads(namespace string) WorkloadNamespaceLister {
	return workloadNamespaceLister{listers.NewNamespaced[*corev1alpha1.Workload](s.ResourceIndexer, namespace)}
}
...
type WorkloadNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*corev1alpha1.Workload, error)
